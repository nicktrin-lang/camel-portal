        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">
              These rules govern your conduct as a Camel Global partner. By operating on the platform
              you agree to comply with all sections below.
            </p>
            <p className="mt-1 text-xs text-slate-400">Last updated April 2026 — subject to change with 14 days&apos; notice.</p>
          </div>
          <button
            type="button"
