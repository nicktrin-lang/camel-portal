        ...
        <div className="flex h-full flex-col overflow-y-auto">
          <div className="border-b border-white/10 px-6 pt-8 pb-6">
            <Link href="/admin" onClick={onClose} className="block">
              ...
              <div className="mt-3 text-sm text-white/75">System administration</div>
            </Link>
          </div>
          <nav className="flex-1 px-4 py-5">
            <div className="mb-3 px-3 text-xs font-semibold uppercase tracking-[0.18em] text-white/55">Administration</div>
