      ...
      <div className="rounded-3xl border border-black/5 bg-white p-8 shadow-[0_18px_45px_rgba(0,0,0,0.08)]">
        <div className="space-y-8 text-[#475569] leading-relaxed">
          ...
          <p>
            ...
            use our <a href="/admin/contact" className="text-[#005b9f] hover:underline">contact form</a>.
          </p>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              ...
              <li>Technical data — IP address, browser type, pages visited (via cookies — see our <a href="/admin/cookies" className="text-[#005b9f] hover:underline">Cookie Policy</a>)</li>
            </ul>
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              <a href="/admin/contact" className="text-[#005b9f] hover:underline">contact form</a>.
          ...
          <div>
            ...
            <p>
              ...
              See our <a href="/admin/cookies" className="text-[#005b9f] hover:underline">Cookie Policy</a> for full details.
            </p>
          </div>
