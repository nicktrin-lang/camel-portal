      ...
      <div className="mx-auto max-w-5xl px-6 space-y-4 pb-10">
        ...
        <div className="bg-white p-8">
          <p className="text-sm font-bold text-black/70 leading-relaxed">
            ...
            <a href="/admin/contact" className="text-[#ff7a00] hover:underline">contact form</a>.
          </p>
        </div>
          ...
          <div className="mb-4 overflow-hidden">
            ...
            <div className="bg-[#f0f0f0] px-5 py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-black/60 mt-1">Stores whether you&apos;ve accepted or rejected non-essential cookies, so we don&apos;t ask you every time you visit. Stored in your browser&apos;s local storage, not as a traditional cookie.</p>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden">
            ...
            <div className="bg-[#f0f0f0] px-5 py-4">
              ...
              <p className="text-sm font-bold text-black/60 mt-1">
                These help us understand how people use the site — which pages are popular, how long people spend on each page, and where they come from.
                The data is aggregated and anonymous. Google&apos;s own privacy policy governs how Google handles this data.
              </p>
        ...
        <div className="bg-white p-8">
          ...
          <p className="text-sm font-bold text-black/70 leading-relaxed mb-3">
            When you first visit the site, a banner lets you accept all cookies or reject non-essential ones. If you change your mind:
          </p>
          <ul className="list-disc list-inside space-y-2 text-sm font-bold text-black/70">
            ...
            <li>Visit your browser&apos;s privacy settings to manage analytics preferences</li>
          </ul>
          <p className="mt-3 text-sm font-bold text-black/70">Note: blocking essential cookies will break the login functionality of the platform.</p>
        </div>
        ...
        <div className="bg-white p-8">
          ...
          <p className="text-sm font-bold text-black/70">
            Use our <a href="/admin/contact" className="text-[#ff7a00] hover:underline">contact form</a> and we&apos;ll get back to you.
          </p>
        </div>
