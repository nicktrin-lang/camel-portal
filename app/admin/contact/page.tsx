            ...
            <div className="space-y-4 text-sm text-[#475569]">
              ...
              <div>
                ...
                <div className="mt-2 space-y-1.5">
                  <a href="/admin/terms" className="flex items-center gap-2 text-[#005b9f] hover:underline text-xs">
                    <span>→</span> Partner Terms
                  </a>
                  <a href="/admin/operating-rules" className="flex items-center gap-2 text-[#005b9f] hover:underline text-xs">
                    <span>→</span> Operating Agreement
                  </a>
                  <a href="/admin/accounts" className="flex items-center gap-2 text-[#005b9f] hover:underline text-xs">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-3xl border border-black/5 bg-white p-8 shadow-[0_18px_45px_rgba(0,0,0,0.08)] space-y-5">
            ...
            <p className="text-center text-xs text-slate-400">
              ...
              <a href="/admin/privacy" className="underline hover:text-slate-600">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
