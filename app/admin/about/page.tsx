    ...
    <div className="w-full">
      ...
      <div className="mx-auto max-w-5xl px-6 space-y-4 pb-10">
        ...
        <div className="bg-white p-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { n: "03", title: "Customer accepts a bid", body: "They choose the best offer. Booking confirmed instantly. The partner is notified immediately." },
              { n: "04", title: "Driver delivers the car", body: "The partner's driver delivers the car to the agreed location. Insurance confirmed on handover." },
              { n: "05", title: "Customer drives", body: "The customer enjoys their hire. The driver collects from wherever they are when done." },
              { n: "06", title: "Fuel settled automatically", body: "Fuel is recorded at delivery and collection. The customer pays only for what was used." },
            ].map(({ n, title, body }) => (
        ...
        <div className="bg-black p-8">
          ...
          <p className="text-sm font-bold text-white/60 mb-6">Questions about the platform or a partnership enquiry?</p>
