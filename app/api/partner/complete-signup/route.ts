...
type Body = {
  ...
  phone?: string; website?: string; password?: string;
  // Business address
  ...
  // Fleet address
  baseAddress?: string; baseAddress1?: string; baseAddress2?: string;
  baseCity?: string; baseProvince?: string; basePostcode?: string; baseCountry?: string;
  baseLat?: number | string | null; baseLng?: number | string | null;
};
...
export async function POST(req: Request) {
  try {
    ...
    // Insert application (including city)
    ...
    // Upsert profile with both business and fleet addresses (including city fields)
